...
public class FileTranscoder {
		...
		groupLayout.setHorizontalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGap(14)
					.addComponent(comboBox1, GroupLayout.PREFERRED_SIZE, 191, GroupLayout.PREFERRED_SIZE)
					.addGap(53)
	...
	public void newFileToUtf(File file){
        try{
            ...
            BufferedReader reader = new BufferedReader(new InputStreamReader(stream,(String)comboBox1.getSelectedItem()));
            ...
            BufferedWriter writer = new BufferedWriter(new OutputStreamWriter(os,(String)comboBox2.getSelectedItem()));
